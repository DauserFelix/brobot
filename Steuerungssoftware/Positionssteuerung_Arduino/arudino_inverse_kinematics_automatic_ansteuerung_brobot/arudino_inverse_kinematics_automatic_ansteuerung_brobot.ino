...
void move_similar_to_position(int stepps_joint_2, int stepps_joint_3)
{
  ...
  while(true)
  {
    if((stepps_joint_2<0)&&(stepps_joint_3<0))
    {
    ...
    else if((stepps_joint_2>0)&&(stepps_joint_3>0))
    {
      digitalWrite(12, LOW);
      digitalWrite(6, LOW);
  ...
  while(true)
  {
    ...
    else if(Mode_from_python=="a")
    {
      while(true)
      {
        ...
        move_similar_to_position(stepps_alpha_joint_2.toInt(), stepps_beta_joint_3.toInt());
