  ...
  while(true)
  {
    ...
    else if(Mode_from_python=="a")
    {
      while(true)
      {
        ...
        // if(stepps_alpha_joint_2=="menu")
        // {
        //   Serial.println("menu");
        //   //Mode_from_python="menu";
        //   break;
        // }
        delay(10);
        ...
        stepps_alpha_joint_2="0";
        stepps_beta_joint_3="0";
        stepps_thetta_joint_4="0";
    ...
    else if(Mode_from_python=="e")
    {
      while(true)
      {
        Serial.println("endeffector_mode");
        break;
      }
    }
    //' else if(Mode_from_python=="menu")
    // {
    //   while(true)
    //   {
    //     Serial.println("menu");
